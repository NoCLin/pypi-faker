...
"""
	if format == 'whl':
		...
		with tempfile.TemporaryDirectory() as tmpdir:
			...
			wheel_path = os.path.join(tmpdir, 'dist', wheel_name)

			result = subprocess.check_output(['python', 'setup.py', 'bdist_wheel'], cwd=tmpdir)
			print(result)
...
async def root(request: Request):
	...
	return Response(f"Hello World! <br> try"
